...
list1 = q1[q1<3].index
basetable = data11[~data11.Country.isin(list1)] # ~ 부정
#q1 = q1
#q1.Country.value_counts()[q1.Country.value_counts() ==3].index

#q1[q1Country == q1.Country.value_counts()>3]
...
from statsmodels.formula.api import ols
from statsmodels.stats.anova import anova_lm
from statsmodels.stats.multicomp import pairwise_tukeyhsd# 다중분석

q3 = ols('Happiness_Score~C(year)', data= basetable).fit() #C는 범주형이다라고 표현
...
print(out1) # reject 가 귀무가설이 기각되지 않았다는 뜻?
...
# =============================================================================
data12['Age']= data12['Age'].astype('object')

data12.info()
data12.columns[data12.dtypes!='object']

q1 = data12[['is_Married', 'Dependent_Count', 'Read_Book_per_Year']]

q1 = q1.corr().drop('Read_Book_per_Year')['Read_Book_per_Year']
abs(q1).max()
...
q2['is_grad'] = q2['Education_Level'].isin(['석사','박사'])+0 #T F + 0 하면 1, 0형태
...
q3 = q3[~q3.Income_Range.isin(['X'])] # x는 결측치
...
q1 = pos1.copy()
q1 = q1.Date.value_counts().idxmax()
pos1[pos1.Date==q1]['itemDescription'].value_counts().nlargest(1)


## 답 7
#q1['itemDescription'].groupby(q1.Date).count().sort_values(ascending=False).index[0]
## whole milk
